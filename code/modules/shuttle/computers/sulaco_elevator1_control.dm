/obj/structure/machinery/computer/shuttle/elevator_controller/elevator_call
	...
	shuttleId = MOBILE_SULACO_CEN1_ELEVATOR
	is_call = TRUE
	var/dockId
...
/obj/structure/machinery/computer/shuttle/elevator_controller/elevator_call/sulaco_central1/upperdeck
	dockId = STAT_SULACO_CEN1UPR

/obj/structure/machinery/computer/shuttle/elevator_controller/elevator_call/sulaco_central1/lowerdeck
	dockId = STAT_SULACO_CEN1LWR
...
/obj/structure/machinery/computer/shuttle/elevator_controller/proc/get_landing_zones()
	. = list()
	for(var/obj/docking_port/stationary/sulaco_central1/elev in SSshuttle.stationary)
		. += list(elev)
